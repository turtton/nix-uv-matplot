{
  ...
  outputs =
    ...
    in
    {
      ...
      packages.x86_64-linux.default = pythonSet.mkVirtualEnv "matplot-env" workspace.deps.default;
      ...
      devShells.x86_64-linux = {
        ...
        uv2nix =
          let
            ...
            virtualenv = editablePythonSet.mkVirtualEnv "matplot-dev-env" workspace.deps.all;
